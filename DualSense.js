class DualSense {
  ...
  setHapticFeedbackByDuration(heavyMotorIntensity, softMotorIntensity, duration) {
    this.outputReportBuffer[3] = heavyMotorIntensity;
    this.outputReportBuffer[2] = softMotorIntensity;
    this.updateOutputReport();
    if (duration > 0) {
      setTimeout(() => {
